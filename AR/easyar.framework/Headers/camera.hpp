...
public:
    ...
    void setCalibration(Vec2F size, Vec2F focalLength, Vec2F principalPoint, float k1, float k2, float p1, float p2);
    void setCameraOrientation(int rotation);
    int imageOrientation(int screenRotation);
    bool imageHorizontalFlip();
    Matrix44F projection(float nearPlane, float farPlane, float viewportAspectRatio, int screenRotation, bool combiningRotation, bool combiningFlip);
    Matrix44F imageProjection(float viewportAspectRatio, int screenRotation, bool combiningRotation, bool combiningFlip);
    Vec2F screenCoordinatesFromImageCoordinates(float viewportAspectRatio, int screenRotation, bool combiningRotation, bool combiningFlip, Vec2F imageCoordinates);
    Vec2F imageCoordinatesFromScreenCoordinates(float viewportAspectRatio, int screenRotation, bool combiningRotation, bool combiningFlip, Vec2F screenCoordinates);
...
inline void CameraParameters::setCalibration(Vec2F arg0, Vec2F arg1, Vec2F arg2, float arg3, float arg4, float arg5, float arg6)
{
    easyar_CameraParameters_setCalibration(cdata_.get(), easyar_Vec2F{{arg0.data[0], arg0.data[1]}}, easyar_Vec2F{{arg1.data[0], arg1.data[1]}}, easyar_Vec2F{{arg2.data[0], arg2.data[1]}}, arg3, arg4, arg5, arg6);
}
