...
- (void)setCalibration:(easyar_Vec2F *)size focalLength:(easyar_Vec2F *)focalLength principalPoint:(easyar_Vec2F *)principalPoint k1:(float)k1 k2:(float)k2 p1:(float)p1 p2:(float)p2;
- (void)setCameraOrientation:(int)rotation;
- (int)imageOrientation:(int)screenRotation;
- (bool)imageHorizontalFlip;
- (easyar_Matrix44F *)projection:(float)nearPlane farPlane:(float)farPlane viewportAspectRatio:(float)viewportAspectRatio screenRotation:(int)screenRotation combiningRotation:(bool)combiningRotation combiningFlip:(bool)combiningFlip;
- (easyar_Matrix44F *)imageProjection:(float)viewportAspectRatio screenRotation:(int)screenRotation combiningRotation:(bool)combiningRotation combiningFlip:(bool)combiningFlip;
- (easyar_Vec2F *)screenCoordinatesFromImageCoordinates:(float)viewportAspectRatio screenRotation:(int)screenRotation combiningRotation:(bool)combiningRotation combiningFlip:(bool)combiningFlip imageCoordinates:(easyar_Vec2F *)imageCoordinates;
- (easyar_Vec2F *)imageCoordinatesFromScreenCoordinates:(float)viewportAspectRatio screenRotation:(int)screenRotation combiningRotation:(bool)combiningRotation combiningFlip:(bool)combiningFlip screenCoordinates:(easyar_Vec2F *)screenCoordinates;
