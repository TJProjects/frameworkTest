...
public:
    ...
    void open(String * server, String * appKey, String * appSecret, CallbackScheduler * callbackScheduler, FunctorOfVoidFromCloudStatus callback_open, FunctorOfVoidFromCloudStatusAndListOfPointerOfTarget callback_recognize);
    bool close();
...
inline void CloudRecognizer::open(String * arg0, String * arg1, String * arg2, CallbackScheduler * arg3, FunctorOfVoidFromCloudStatus arg4, FunctorOfVoidFromCloudStatusAndListOfPointerOfTarget arg5)
{
    if (cdata_ == NULL) {
        return;
    }
    easyar_CloudRecognizer_open(cdata_, arg0->get_cdata(), arg1->get_cdata(), arg2->get_cdata(), (arg3 == NULL ? NULL : arg3->get_cdata()), FunctorOfVoidFromCloudStatus_to_c(arg4), FunctorOfVoidFromCloudStatusAndListOfPointerOfTarget_to_c(arg5));
}
