...
void easyar_CameraParameters_setCalibration(easyar_CameraParameters * This, easyar_Vec2F size, easyar_Vec2F focalLength, easyar_Vec2F principalPoint, float k1, float k2, float p1, float p2);
...
easyar_Matrix44F easyar_CameraParameters_projection(easyar_CameraParameters * This, float nearPlane, float farPlane, float viewportAspectRatio, int screenRotation, bool combiningRotation, bool combiningFlip);
easyar_Matrix44F easyar_CameraParameters_imageProjection(easyar_CameraParameters * This, float viewportAspectRatio, int screenRotation, bool combiningRotation, bool combiningFlip);
easyar_Vec2F easyar_CameraParameters_screenCoordinatesFromImageCoordinates(easyar_CameraParameters * This, float viewportAspectRatio, int screenRotation, bool combiningRotation, bool combiningFlip, easyar_Vec2F imageCoordinates);
easyar_Vec2F easyar_CameraParameters_imageCoordinatesFromScreenCoordinates(easyar_CameraParameters * This, float viewportAspectRatio, int screenRotation, bool combiningRotation, bool combiningFlip, easyar_Vec2F screenCoordinates);
